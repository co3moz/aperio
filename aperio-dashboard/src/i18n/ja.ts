...
export const ja: Record<string, string> = {
  ...
  'Live Tail': 'ライブテール',
  'tail -f of the access log': 'アクセスログの tail -f 表示',
  'Live Log Tail': 'ライブログテール',
  'Freeze the stream while you read': '読む間ストリームを固定',
  'Filter by host/path/method/status...': 'ホスト/パス/メソッド/ステータスで絞り込み...',
  'Waiting for the stream...': 'ストリームを待機中...',
  'No requests yet — the tail follows new traffic as it arrives.': 'まだリクエストはありません — テールは新しいトラフィックを追跡します。',
  'Jump to latest': '最新へ移動',
  'Showing the newest {max} lines; click a line to open the inspector.': '最新の {max} 行を表示中。行をクリックするとインスペクターが開きます。',
  'Paused — stream frozen at {count} requests.': '一時停止 — {count} 件でストリームを固定しました。',
