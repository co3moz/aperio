...
export const ja: Record<string, string> = {
  ...
  'Leave a field empty for no limit. Usage is for the current calendar month.': '制限しない項目は空欄にしてください。使用量は当月（暦月）の集計です。',
  ...
  'Quota & usage': 'クォータと使用量',
  'Quota & usage — {name}': 'クォータと使用量 — {name}',
  'Quota updated': 'クォータを更新しました',
