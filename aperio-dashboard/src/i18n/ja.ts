...
export const ja: Record<string, string> = {
  ...
  'One entry per exposed backend. This is the shape to write by hand; the two are mutually exclusive, so the single-service keys are hidden.': '公開するバックエンドごとに 1 エントリ。手書きするならこの形式です。両者は排他なので、単一サービス用のキーは非表示になります。',
  ...
  'Exposed service': '公開サービス',
  'The single backend this client exposes and where it is bound.': 'このクライアントが公開する単一のバックエンドと、そのバインド先。',
