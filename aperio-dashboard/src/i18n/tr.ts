...
export const tr: Record<string, string> = {
  ...
  'The server stops calling this endpoint, so the service will no longer cold start or scale out. A client that is still running and still declares the block re-arms it on its next heartbeat.': 'Sunucu bu uç noktayı çağırmayı bırakır, dolayısıyla servis artık soğuk başlatılmaz veya ölçeklenmez. Hâlâ çalışan ve bloğu tanımlamayı sürdüren bir istemci, bir sonraki kalp atışında kaydı yeniden oluşturur.',
  ...
  'Too many consecutive failures: the endpoint is no longer called. Fix it and restart the client to re-arm.': 'Arka arkaya çok fazla hata: uç nokta artık çağrılmıyor. Düzeltip istemciyi yeniden başlatarak tekrar etkinleştirin.',
  'URL': 'URL',
  ...
  'Caching, resilience, and the headers this client rewrites.': 'Önbellekleme, dayanıklılık ve bu istemcinin yeniden yazdığı başlıklar.',
  'Logging': 'Günlükleme',
  ...
  'Pages & headers': 'Sayfalar ve başlıklar',
  ...
  'Random-subdomain services answer with X-Robots-Tag: noindex and a disallow-all robots.txt': 'Rastgele alt alan adlı servisler X-Robots-Tag: noindex ve her şeyi yasaklayan bir robots.txt ile yanıt verir',
