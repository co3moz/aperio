...
export const tr: Record<string, string> = {
  ...
  'Leave a field empty for no limit. Usage is for the current calendar month.': 'Sınır istemiyorsanız alanı boş bırakın. Kullanım, içinde bulunulan takvim ayına aittir.',
  ...
  'Quota & usage': 'Kota ve kullanım',
  'Quota & usage — {name}': 'Kota ve kullanım — {name}',
