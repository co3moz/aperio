...
export const tr: Record<string, string> = {
  ...
  'Single service': 'Tek servis',
  'New entry name': 'Yeni kayıt adı',
  'none configured': 'yapılandırılmamış',
  '{n} entry(s) configured': '{n} kayıt yapılandırıldı',
  'One entry per exposed backend. This is the shape to write by hand; the two are mutually exclusive, so the single-service keys are hidden.': 'Yayınlanan her arka uç için bir kayıt. Elle yazılacak yapı budur; ikisi birbirini dışladığı için tek servis anahtarları gizlenir.',
  ...
  'Exposed service': 'Yayınlanan servis',
  'The single backend this client exposes and where it is bound.': 'Bu istemcinin yayınladığı tek arka uç ve nereye bağlandığı.',
