...
export const de: Record<string, string> = {
  ...
  'Leave a field empty for no limit. Usage is for the current calendar month.': 'Ein leeres Feld bedeutet kein Limit. Die Nutzung bezieht sich auf den laufenden Kalendermonat.',
  ...
  'Quota & usage': 'Kontingent & Nutzung',
  'Quota & usage — {name}': 'Kontingent & Nutzung — {name}',
  'Quota updated': 'Kontingent aktualisiert',
