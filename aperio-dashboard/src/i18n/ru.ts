...
export const ru: Record<string, string> = {
  ...
  'Leave a field empty for no limit. Usage is for the current calendar month.': 'Оставьте поле пустым, чтобы не задавать лимит. Расход считается за текущий календарный месяц.',
  ...
  'Quota & usage': 'Квота и расход',
  'Quota & usage — {name}': 'Квота и расход — {name}',
