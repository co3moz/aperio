...
export const ru: Record<string, string> = {
  ...
  'No dashboard users yet, the master token and dashboard password still work.': 'Пользователей панели пока нет, мастер-token и пароль панели по-прежнему работают.',
  'Operator': 'Оператор',
  'Password (min. 8 characters)': 'Пароль (не менее 8 символов)',
  'Role': 'Роль',
  'Role-based access. The master token and dashboard password always sign in as a built-in admin ("aperio").': 'Доступ на основе ролей. Мастер-token и пароль панели всегда входят как встроенный администратор («aperio»).',
