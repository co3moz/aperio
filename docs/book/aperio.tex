...
present it is authoritative and those fields are ignored. This server
accepts a list of exactly one, the shape it already served, and refuses
a longer one at the Ping rather than serving part of it.
