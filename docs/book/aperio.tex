...
sudo dpkg -i aperio-server_0.9.0_amd64.deb   # or: rpm -i aperio-server-...rpm
...
The current protocol version is 8. Version 3 added flow control for
...
current protocol version is 8, negotiated per connection, and each step
...
client gives a service, so a multiplexed one needs a \code{name:}. An
