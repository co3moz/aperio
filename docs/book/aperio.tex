...
\code{APERIO\_BACKUP\_KEY\_FILE} & File holding that key. Refused when it is inside \code{APERIO\_BACKUP\_DIR}: whoever has the backups would have the key. Restore with \code{aperio-server --decrypt-backup}. & off \\
\rowsep
