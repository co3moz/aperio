...
\rowsep
\code{GET/POST /aperio/api/maintenance} & List / toggle maintenance mode for a hostname, a \code{*.example.com} subdomain wildcard, or \code{*} (master only). & dashboard session \\
\rowsep
