...
- [The Embedded Profile](embedded-profile.md), the written minimum of the tunnel protocol for a device that cannot run the client: which messages it must handle, which it may ignore, and which it is not sent.
